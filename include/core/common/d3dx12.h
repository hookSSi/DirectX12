...
struct CD3DX12_HEAP_DESC : public D3D12_HEAP_DESC
{
        ...
        CD3DX12_HEAP_DESC(UINT64 size, D3D12_HEAP_TYPE type,
                          UINT64 alignment = 0,
                          D3D12_HEAP_FLAGS flags = D3D12_HEAP_FLAG_NONE)
        {
            SizeInBytes = size;
...
struct CD3DX12_RESOURCE_BARRIER : public D3D12_RESOURCE_BARRIER
{
        ...
        static inline CD3DX12_RESOURCE_BARRIER
        UAV(_In_ ID3D12Resource *pResource)
        {
            CD3DX12_RESOURCE_BARRIER result;
            ZeroMemory(&result, sizeof(result));
            D3D12_RESOURCE_BARRIER &barrier = result;
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT
{
        ...
        CD3DX12_SUBRESOURCE_FOOTPRINT(DXGI_FORMAT format, UINT width,
        ...
        explicit CD3DX12_SUBRESOURCE_FOOTPRINT(
            const D3D12_RESOURCE_DESC &resDesc, UINT rowPitch)
        {
...
struct CD3DX12_ROOT_PARAMETER : public D3D12_ROOT_PARAMETER
{
        ...
        inline void InitAsConstants(
            ...
            D3D12_SHADER_VISIBILITY visibility = D3D12_SHADER_VISIBILITY_ALL)
        {
            InitAsConstants(*this, num32BitValues, shaderRegister,
                            registerSpace, visibility);
        }
...
struct CD3DX12_STATIC_SAMPLER_DESC : public D3D12_STATIC_SAMPLER_DESC
{
        ...
        CD3DX12_STATIC_SAMPLER_DESC(
            ...
            UINT registerSpace = 0)
        {
            Init(shaderRegister, filter, addressU, addressV, addressW,
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
        ...
        {
            handle.ptr =
                base.ptr + offsetInDescriptors * descriptorIncrementSize;
        }
};
...
struct CD3DX12_RESOURCE_DESC : public D3D12_RESOURCE_DESC
{
        ...
        CD3DX12_RESOURCE_DESC(D3D12_RESOURCE_DIMENSION dimension,
                              UINT64 alignment, UINT64 width, UINT height,
                              UINT16 depthOrArraySize, UINT16 mipLevels,
        ...
        {
            return CD3DX12_RESOURCE_DESC(
                D3D12_RESOURCE_DIMENSION_TEXTURE1D, alignment, width, 1,
                arraySize, mipLevels, format, 1, 0, layout, flags);
        }
        static inline CD3DX12_RESOURCE_DESC
        Tex2D(DXGI_FORMAT format, UINT64 width, UINT height,
              UINT16 arraySize = 1, UINT16 mipLevels = 0, UINT sampleCount = 1,
        ...
        {
            return CD3DX12_RESOURCE_DESC(
                D3D12_RESOURCE_DIMENSION_TEXTURE3D, alignment, width, height,
...
CommandListCast(ID3D12GraphicsCommandList *const *pp)
{
